...
Taf.DataHelp = {
    ...
    Taf.BinBuffer.prototype.memset = function(t, e, r) {
        this.allocate(r),
            new Uint8Array(this.buf).set(new Uint8Array(t,e,r), this.position)
    }
    ,
    ...
    Taf.JceOutputStream.prototype.writeString = function(t, e) {
        ...
        r.length > 255 ? (this.writeTo(t, Taf.DataHelp.EN_STRING4),
                this.buf.writeUInt32(r.length)) : (this.writeTo(t, Taf.DataHelp.EN_STRING1),
    ...
    Taf.JceOutputStream.prototype.writeVector = function(t, e) {
        ...
        for (var r = 0; r < e.value.length; r++)
            e.proto._write(this, 0, e.value[r])
    }
    ,
    Taf.JceOutputStream.prototype.writeMap = function(t, e) {
        ...
        for (var r in e.value)
            e.kproto._write(this, 0, r),
                e.vproto._write(this, 1, e.value[r])
    }
    ,
    ...
    Taf.JceInputStream.prototype.skipToTag = function(t, e) {
        for (; this.buf.position < this.buf.length; ) {
            var r = this.peekFrom();
            if (t <= r.tag || r.type == Taf.DataHelp.EN_STRUCTEND)
                return r.type == Taf.DataHelp.EN_STRUCTEND ? !1 : t == r.tag;
            this.buf.position += r.size,
    ...
    Taf.JceInputStream.prototype.readStruct = function(t, e, r) {
        if (0 == this.skipToTag(t, e))
            return r;
        var i = this.readFrom();
        if (i.type != Taf.DataHelp.EN_STRUCTBEGIN)
            throw Error("read struct type mismatch, tag: " + t + ", get type:" + i.type);
        return r.readFrom(this),
            this.skipToStructEnd(),
            r
    }
    ,
    Taf.JceInputStream.prototype.readString = function(t, e, r) {
        if (0 == this.skipToTag(t, e))
            return r;
        var i = this.readFrom();
        if (i.type == Taf.DataHelp.EN_STRING1)
            return this.buf.readString(this.buf.readUInt8());
        if (i.type == Taf.DataHelp.EN_STRING4)
    ...
    Taf.JceInputStream.prototype.readBytes = function(t, e, r) {
        ...
        if (i.type == Taf.DataHelp.EN_SIMPLELIST) {
            var a = this.readFrom();
            if (a.type != Taf.DataHelp.EN_INT8)
                throw Error("type mismatch, tag:" + t + ",type:" + i.type + "," + a.type);
            var n = this.readInt32(0, !0);
            if (0 > n)
                throw Error("invalid size, tag:" + t + ",type:" + i.type + "," + a.type);
    ...
    Taf.JceInputStream.prototype.readVector = function(t, e, r) {
        ...
        var i = this.readFrom();
        if (i.type != Taf.DataHelp.EN_LIST)
            throw Error("read 'vector' type mismatch, tag: " + t + ", get type: " + i.type);
        var a = this.readInt32(0, !0);
        if (0 > a)
            throw Error("invalid size, tag: " + t + ", type: " + i.type + ", size: " + a);
        for (var n = 0; a > n; ++n)
            r.value.push(r.proto._read(this, 0, r.proto._clone()));
        return r
    }
    ,
    Taf.JceInputStream.prototype.readMap = function(t, e, r) {
        if (0 == this.skipToTag(t, e))
            return r;
        var i = this.readFrom();
        if (i.type != Taf.DataHelp.EN_MAP)
            throw Error("read 'map' type mismatch, tag: " + t + ", get type: " + i.type);
        var a = this.readInt32(0, !0);
        if (0 > a)
            throw Error("invalid map, tag: " + t + ", size: " + a);
        for (var n = 0; a > n; n++) {
            var o = r.kproto._read(this, 0, r.kproto._clone())
                , f = r.vproto._read(this, 1, r.vproto._clone());
            r.put(o, f)
        }
        return r
    }
...
Taf.Wup = function() {
    ...
    Taf.Wup.prototype.writeBoolean = function(t, e) {
        ...
        if (r.writeBoolean(0, e),
            3 == this.iVersion)
            this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
        else {
            ...
            i.put(a, new Taf.BinBuffer(r.getBuffer())),
                this.data.put(t, i)
        }
    }
    ,
    ...
    Taf.Wup.prototype.writeInt16 = function(t, e) {
        ...
        if (r.writeInt16(0, e),
            ...
            i.put(a, new Uint8Array(r.getBuffer())),
                this.data.put(t, i)
        }
    }
    ,
    ...
    Taf.Wup.prototype.writeString = function(t, e) {
        var r = new Taf.JceOutputStream;
        if (r.writeString(0, e),
            3 == this.iVersion)
            this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
        else {
            var i = this.data.get(t)
                , a = Taf.TypeHelp.STRING;
            if (void 0 == i) {
                var n = new Taf.Map(Taf.STRING,Taf.STRING);
                i = n
            }
    ...
    Taf.Wup.prototype.writeVector = function(t, e) {
        var r = new Taf.JceOutputStream;
        if (r.writeVector(0, e),
            3 == this.iVersion)
            this.newdata.put(t, new Taf.BinBuffer(r.getBinBuffer()));
        else {
            var i = this.data.get(t)
                , a = e._className();
            if (void 0 == i) {
    ...
    Taf.Wup.prototype.decode = function(t) {
        var e = new Taf.JceInputStream(t)
            , r = e.buf.vew.getInt32(e.buf.position);
        if (4 > r)
    ...
    Taf.Wup.prototype.readBoolean = function(t) {
        ...
        if (3 == this.iVersion) {
            ...
            if (e = this.newdata.get(t),
                void 0 == e)
                throw Error("UniAttribute not found key:" + t);
            var a = Taf.TypeHelp.BOOLEAN
                , n = e.get(a);
            if (void 0 == n)
                throw Error("UniAttribute not found type:" + a);
    ...
    Taf.Wup.prototype.readInt16 = function(t) {
        ...
        if (3 == this.iVersion) {
            ...
            if (e = this.newdata.get(t),
                void 0 == e)
                throw Error("UniAttribute not found key:" + t);
            var a = Taf.TypeHelp.SHORT
                , n = e.get(a)
                , i = new Taf.JceInputStream(n);
            if (void 0 == n)
                throw Error("UniAttribute not found type:" + a);
            r = i.readInt16(0, !0, r)
        }
...
Taf.Util = Taf.Util || {},
    Taf.Util.jcestream = function(t) {
        ...
        for (var e = new Uint8Array(t), r = "", i = 0; i < e.length; i++)
            0 != i && i % 16 == 0 ? r += "\n" : 0 != i && (r += " "),
                r += (e[i] > 15 ? "" : "0") + e[i].toString(16);
    ...
    Taf.Util.ajax = function(t, e, r, i) {
        ...
        var n = function() {
            4 === a.readyState && (200 === a.status || 304 === a.status ? r(Taf.Util.str2ab(a.response)) : i(a.status),
                a.removeEventListener("readystatechange", n),
                a = void 0)
        };
        a.addEventListener("readystatechange", n),
            a.open("post", t),
            a.send(e)
    }
;
...
function TafHandler() {
    ...
    function a(n) {
        i.connected = !1,
            ...
            10 > f ? (f++,
                    console.warn("%c=== WebSocket 重连" + f + "... ===", "font-size:120%"),
    ...
    function r(e) {
        ...
        n.onload = function() {
            var e = this.result
                , n = new Taf.JceInputStream(e)
                , t = new HUYA.WebSocketCommand;
            switch (t.readFrom(n),
                t.iCmdType) {
                case HUYA.EWebSocketCommandType.EWSCmd_RegisterRsp:
                    ...
                    a.readFrom(n),
                        console.log("%c<<<<<<< %crspRegister", c("#0000E3"), c("#D9006C"), a),
                        i.dispatch("WSRegisterRsp", a);
                    break;
                case HUYA.EWebSocketCommandType.EWSCmd_WupRsp:
                    ...
                    if (r) {
                        ...
                        o.readStruct(s, r, TafMx.WupMapping[o.sFuncName]),
                            console.log("%c<<<<<<< %crspWup:%c " + o.sFuncName, c("#0000E3"), c("black"), c("#0000E3"), r),
                            i.dispatch(o.sFuncName, r)
                    } else
                        i.dispatch(o.sFuncName);
                    break;
                case HUYA.EWebSocketCommandType.EWSCmdS2C_MsgPushReq:
                    n = new Taf.JceInputStream(t.vData.buffer);
                    var f = new HUYA.WSPushMessage;
                    f.readFrom(n),
                        n = new Taf.JceInputStream(f.sMsg.buffer);
                    var u = TafMx.UriMapping[f.iUri];
                    u && (u = new u,
                        u.readFrom(n),
                        console.log("%c<<<<<<< %crspMsgPush, %ciUri=" + f.iUri, c("#0000E3"), c("black"), c("#8600FF"), u),
                        i.dispatch(f.iUri, u));
                    break;
                case HUYA.EWebSocketCommandType.EWSCmdS2C_HeartBeatAck:
                    console.log("%c<<<<<<< rspHeartBeat: " + (new Date).getTime(), c("#0000E3"));
                    break;
                case HUYA.EWebSocketCommandType.EWSCmdS2C_VerifyCookieRsp:
                    ...
                    p.readFrom(n);
                    var d = 0 == p.iValidate;
                    console.log("%c<<<<<<< %cVerifyCookie", c("#0000E3"), c("#D9006C"), "校验" + (d ? "通过！" : "失败！"), p);
                    break;
                default:
                    console.warn("%c<<<<<<< Not matched CmdType: " + t.iCmdType, c("#red"))
            }
        }
            ,
    ...
    e(),
        this.sendWup = function(e, t, a) {
            ...
            o.setServant(e),
                o.setFunc(t),
                o.writeStruct("tReq", a);
            var r = new HUYA.WebSocketCommand;
            r.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_WupReq,
                r.vData = o.encode();
            var s = new Taf.JceOutputStream;
            r.writeTo(s),
                n(s.getBuffer()),
                console.log("%c>>>>>>> %creqWup: %c" + t, c("#009100"), c("black"), c("#009100"), a)
        }
        ,
        this.sendRegister = function(e) {
            ...
            a.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_RegisterReq,
                a.vData = t.getBinBuffer(),
                t = new Taf.JceOutputStream,
                a.writeTo(t),
                n(t.getBuffer()),
                console.log("%c>>>>>>> %creqRegister:", c("#009100"), c("#D26900"), e)
        }
    ;
    var u = {};
    this.addListener = function(e, n) {
        return "undefined" == typeof u[e] && (u[e] = []),
        "function" == typeof n && u[e].push(n),
            this
    }
        ,
        this.dispatch = function(e, n) {
            ...
            if (t instanceof Array) {
                for (var a = 0, o = t.length; o > a; a += 1)
        ...
        this.removeListener = function(e, n) {
            var t = u[e];
            if ("string" == typeof e && t instanceof Array)
...
function HuYaListener(topsid,subsid){
    ...
    function t() {
        ...
        n.tId = a, n.tLiveUB.eSource = HUYA.ELiveSource.WEB_HUYA, s.sendWup("liveui", "doLaunch", n)
    }

    function o() {
        var n = new HUYA.WSUserInfo;
        n.lUid = G.yyuid, n.bAnonymous = 0 == G.yyuid, n.sGuid = a.sGuid, n.sToken = "", n.lTid = G.topsid, n.lSid = G.subsid, n.lGroupId = 0, n.lGroupType = 0, s.sendRegister(n)
    }

    function e() {
        var n = new HUYA.UserChannelReq;
        n.tId = a, n.lTopcid = G.topsid, n.lSubcid = G.subsid, n.sSendContent = "", console.log("\u8ba2\u9605\u9891\u9053\uff1a", G.topsid, G.subsid), s.sendWup("liveui", "userIn", n);
    }

    function i() {
        var n = new HUYA.GetPropsListReq;
    ...
    s.addListener("WEBSOCKET_CONNECTED", function () {
        ...
        LiveJsChat.onLogin("WEBSOCKET_CONNECTED");
    }), s.addListener("doLaunch", function (n) {
        a.sGuid = n.sGuid, o(), e();
        LiveJsChat.onLogin("doLaunch");
    }), s.addListener("WSRegisterRsp", function () {
        LiveJsChat.onLogin("WSRegisterRsp");
